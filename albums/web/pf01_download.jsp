            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-md-4" data-aos="fade-up">
                        <div class="card-custom rounded-4 bg-base shadow-effect">
                            <div class="card-custom-content p-4">
                                <h5 class="mb-4">64 Corvair</h5>
                                <a href="/albums/sound/${productCode}/corvair.mp3" class="link-custom">MP3</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4" data-aos="fade-up">
                        <div class="card-custom rounded-4 bg-base shadow-effect">
                            <div class="card-custom-content p-4">
                                <h5 class="mb-4">Whiskey Before Breakfast</h5>
                                <a href="/albums/sound/${productCode}/whiskey.mp3" class="link-custom">MP3</a>
                            </div>
                        </div>
                    </div>
